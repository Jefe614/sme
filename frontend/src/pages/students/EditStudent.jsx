...
import { getClasses, getStudent, updateStudent } from '../../api/auth';
  ...
  const fetchStudentData = async () => {
    try {
      ...
      form.setFieldsValue({
        ...
        dateOfBirth: student.date_of_birth ? dayjs(student.date_of_birth) : null,
        nationality: student.nationality,
        class: student.student_class?.id,
    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <Text type="secondary">Update student information and details</Text>
        </div>
